$(document).ready(function(){
   ...
   $(".recherche").keyup(function(e) {
      ...
      /* gere l'affichage des elements de la derniere page*/
              ...
              if (liste_paiements.length != 0){
                  ...
                  for (var i = debut; i < fin; i++) {
                      ...
                      type_payement = liste_paiements[i].type_payement;
                      person = liste_paiements[i].person;
    ...
    $("body").on("click", ".ajouter-paiement-link", function() {
        ...
        // $("#modal_ajouter_paiement .type_payement").val(type_payement);
        // $("#modal_ajouter_paiement .person").val(person);
        ...
        $("#modal_ajouter_paiement .type_payement").val("");
        $("#modal_ajouter_paiement .person").val("");
...
//class="{{ cycl.id }}²²{{ cycl.libelle }}²²{{ cycl.sous_paiement }}²²{{ cycl.paiement }}"
        ...
        type_payement = tab_element[2];
        person = tab_element[3];
        entree_sortie_caisee = tab_element[4];
        montant = parseFloat(tab_element[5]);
      
        $("#modal_detail_paiement .libelle").val(libelle);
        $("#modal_detail_paiement .type_payement").val(type_payement);
        $("#modal_detail_paiement .person").val(person);
        ...
        $("#modal_detail_paiement .type_payement").attr("disabled", "True");
        $("#modal_detail_paiement .person").attr("disabled", "True");
    ...
    $(".modifier-paiement-link").click(function() {
        ...
        $("#modal_modifier_paiement .type_payement").val(type_payement);
        $("#modal_modifier_paiement .person").val(person);
        ...
        $("#modal_modifier_paiement .type_payement").removeAttr("disabled");
        $("#modal_modifier_paiement .person").removeAttr("disabled");
    ...
    $(".supprimer-paiement-link").click(function() {
      ...
      $("#modal_supprimer_paiement .type_payement").text(type_payement);
      $("#modal_supprimer_paiement .person").text(person);
