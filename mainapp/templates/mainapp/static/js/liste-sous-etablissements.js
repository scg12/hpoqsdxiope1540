   ...
   $(".recherche").keyup(function(e) {
        ...
        console.log(data);
          ...
          if(data.permissions.indexOf("etab") == -1){
            ...
            //$("table thead").remove();
              ...
              liste_sous_etablissements = data.sous_etablissements;
      ...
      /* gere l'affichage des elements de la derniere page*/
              if (liste_page[liste_page.length-1] == numero_page_active){
                ...
                fin = data.sous_etablissements.length;
              }
              ...
              if (liste_sous_etablissements.length != 0){
                  ...
                  for (var i = debut; i < fin; i++) {
                      ...
                      matricule = liste_sous_etablissements[i].nom_sousetab;
                      nom = liste_sous_etablissements[i].date_creation;
                      prenom = liste_sous_etablissements[i].nom_fondateur;
